...
export default function HW1BioProblemsPage() {
  ...
  // Replace physics questions with biology questions
  const problems = [
    {
  ...
  return (
    <div className="min-h-screen bg-white p-6">
      {/* 🔙 Back to Assignment */}
      <button
        onClick={() => router.push("/assignments/biology/hw1")}
        className="text-blue-500 hover:underline mb-4 text-sm"
      >
        ← Back to Assignment
      </button>

      <h2 className="text-2xl font-bold mb-2 text-black">AP Biology HW #1</h2>
      ...
      {!isFinalStep ? (
        <>
          {/* Problem Box */}
          <div className="bg-[#d4f0d9] rounded-lg p-6 text-black mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div className="bg-[#d4f0d9] rounded-lg p-6 text-black">
