    ...
    <div className="flex h-screen bg-[#e2ecf4]">
      ...
      <div className="flex-1 p-6 overflow-auto">
        <div className="bg-white rounded-xl shadow-md p-6 h-full relative">
          ...
          {/* Header */}
          <div className="mb-6">
            <h2 className="text-xl font-bold text-black">Course: AP Biology</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-green-100 rounded-lg p-6 text-black space-y-2">
              <p>
              ...
              <Link href="/assignments/biology/hw1/problem1">
                <button className="mt-6 bg-red-300 text-white px-6 py-2 rounded-md text-sm font-semibold">
                  Start
                </button>
              </Link>
            </div>
