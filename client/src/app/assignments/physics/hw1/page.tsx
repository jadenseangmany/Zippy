        ...
        <div className="bg-white rounded-xl shadow-md p-6 h-full relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#d4e3ed] rounded-lg p-6 text-black space-y-2">
              ...
              <p><strong>Estimated Time to Complete:</strong> 4 Hours</p>
              <p><strong>Released on:</strong> April 3</p>
            ...
            {/* Right: Leaderboard */}
            <div>
              <h3 className="text-lg font-bold text-black mb-3">AP Physics HW #1 Leaderboard</h3>
